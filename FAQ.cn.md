...
就我个人，已经审阅了 2000+ 条 install。我发现有很多优秀的项目因为没有 promotion、曲高和寡，或者是基础项目，即使是用心良作，也很少 stars。

我看到最极端的项目是 [https://github.com/ProtonMail/gosop](https://github.com/ProtonMail/gosop) —— 我点 star 那回只有 29 个 stars，现在也只有 50 个 stars。这是一个非常专业且有用的项目。

所以本索引不按 stars 过滤。stars 衡量的是营销覆盖和已有受众，不是工具好不好用。相比"已经火"的工具，我们更愿意把时间和注意力放在这些项目上，一方面让其目标用户可以知道并轻松使用，另一方面，希望能侧面帮他们招揽更多的维护者，这样项目可以更深入地发展。
