...
我个人手审过 2000+ 条 install，最好的工具大致落在两类，stars 在这两类里都失真：

- **小众 / 基础设施** —— 大家都在用、但没人想到去 star 的工具。你堆栈底层的库；只在主工具挂了才打开的 CLI；你 grep 但从不 star 的配置文件格式。
- **安静的维护者** —— 埋头干活、不营销自己。不开会、不上 HN、不"follow 我"。纯口碑传播，甚至没有口碑。
